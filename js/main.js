...
const handleOutgoingMsg = (e) => {
    e.preventDefault();
    userData.message = messageInput.value.trim(); // Storing the uses's message by creating a global object making it accessible throughout the project
    ...
    const outgoingMsgDiv =  createMessageElement(messageContent, "user-message");
    ...
    const incomingMsgDiv =  createMessageElement(messageContent, "bot-message", "thinking");
...
messageInput.addEventListener('keydown', (e) => {
    const userMessage = e.target.value.trim(); // trim() method removes whitespace from both sides of a string
